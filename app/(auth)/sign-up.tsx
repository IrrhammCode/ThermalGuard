...
export default function SignUpScreen() {
  ...
  const canSubmit = name.trim().length >= 2 && email.includes('@') && password.length >= 8 && confirm.length >= 8;
    ...
    <KeyboardAvoidingView style={styles.root} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <ScrollView
        ...
        <FadeInView>
          ...
          <Text style={styles.deck}>Stays on this iPhone. The FortyGuard key stays on the Mac.</Text>
          <PhotoBand source={art.atrium} height={128} style={{ marginTop: 20 }} />
        </FadeInView>
        ...
        <FadeInView delay={80}>
          ...
          <AuthField
            ...
            password
            helper="8+ characters, letter and number."
